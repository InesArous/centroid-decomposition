...
CREATE FUNCTION centroid_decomposition(x1 float, x2 float, x3 float, x4 float) RETURNS STRING LANGUAGE PYTHON {
    ...
    working_directory = '/Volumes/GoogleDrive/My Drive/Phd/code/centroid-decomposition/centroid_without_string'
    sys.path.append(working_directory)
    import cd_ssv
    matrix = []
...
#INSERT INTO time_series VALUES ('7.0 -5.0 10.0'), ('9.0 1.0 0.0'), ('-8.0 10.0 6.0'), ('9.0 10.0 -8.0'), ('3.0 -7.0 -2.0'), ('-8.0 10.0 9.0');
COPY 1000 RECORDS INTO time_series FROM '/Volumes/GoogleDrive/My Drive/Phd/code/centroid-decomposition/centroid_without_string/climate.csv' USING DELIMITERS ',','\n';
